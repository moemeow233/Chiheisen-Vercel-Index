...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kawakaze-mirai@ms.800233.xyz',
...
protectedRoutes: ['/🌞 Private folder/Cosplay', '/🥟 Some test files/Protected route'],
